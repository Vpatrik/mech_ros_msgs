#ifndef _ROS_bebop_control_Path_h
#define _ROS_bebop_control_Path_h
...
namespace bebop_control
{
  ...
  class Path : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Point _waypoints_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(waypoints_lengthT > waypoints_length)
        this->waypoints = (geometry_msgs::Point*)realloc(this->waypoints, waypoints_lengthT * sizeof(geometry_msgs::Point));
      waypoints_length = waypoints_lengthT;
      for( uint32_t i = 0; i < waypoints_length; i++){
      offset += this->st_waypoints.deserialize(inbuffer + offset);
        memcpy( &(this->waypoints[i]), &(this->st_waypoints), sizeof(geometry_msgs::Point));
      }
     return offset;
    }

    const char * getType(){ return "bebop_control/Path"; };
    const char * getMD5(){ return "0511c019d3d3f0edeb56aaf3709c8aea"; };
