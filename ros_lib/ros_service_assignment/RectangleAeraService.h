#ifndef _ROS_SERVICE_RectangleAeraService_h
#define _ROS_SERVICE_RectangleAeraService_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RECTANGLEAERASERVICE[] = "ros_service_assignment/RectangleAeraService";

  class RectangleAeraServiceRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RECTANGLEAERASERVICE; };
    const char * getMD5(){ return "ed3043f094c99bdd8118bc5b0ddb14ba"; };

  };

  class RectangleAeraServiceResponse : public ros::Msg
  {
    public:
      typedef float _area_type;
      _area_type area;

    RectangleAeraServiceResponse():
      area(0)
    {
    }
