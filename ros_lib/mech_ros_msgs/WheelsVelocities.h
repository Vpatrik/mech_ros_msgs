#ifndef _ROS_mech_ros_msgs_WheelsVelocities_h
#define _ROS_mech_ros_msgs_WheelsVelocities_h
...
namespace mech_ros_msgs
{
  ...
  class WheelsVelocities : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "mech_ros_msgs/WheelsVelocities"; };
    const char * getMD5(){ return "704d6e45a144b051d9261eee9f265122"; };
